...
def read_cinrad_archive(filename, field_names=None, additional_metadata=None,
    ...
    nfile = CINRADLevel2File(prepare_for_read(filename))
    ...
    if 'icao' in nfile.volume_header.keys():
        metadata['instrument_name'] = nfile.volume_header['icao']
